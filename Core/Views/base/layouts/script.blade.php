                ...
                if (is_for_browse_file) {
                    ...
                    for (let i = 0; i < media_files.length; i++) {
                        if (media_files[i].id == id) {
                            ...
                            let media_path = media_files[i].path;;
                            ...
                            if ($('#list_item_' + id).hasClass('selected')) {
                                ...
                                selected_file_location['file_' + id] = media_path;
                    ...
                    for (let i = 0; i < media_files.length; i++) {
                        if (media_files[i].id == id) {
                            ...
                            let file_path = media_files[i].path;

                            $('#file_name').html(media_files[i].name)
                            $('#file_url').val(file_path)
                            $('#download_file').attr('href', file_path)
                            ...
                            $('#preview_image').attr('src', file_path);
                            ...
                            if ($('#list_item_' + id).hasClass('selected')) {
                                ...
                                $('#list_item_' + id).addClass("selected");
                                selected_file_location['file_' + id] = media_files[i].path
                                selected_file_id.push(id);
                            }
                        }
                    }
